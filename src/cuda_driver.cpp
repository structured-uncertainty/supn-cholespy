...
//NDFC Added to work with shuffled data..
CUfunction solve_upper_with_shuffle_float;
CUfunction solve_upper_with_shuffle_double;
CUfunction solve_lower_with_shuffle_float;
CUfunction solve_lower_with_shuffle_double;
...
bool init_cuda() {
    ...
    //NDFC Added to work with shuffled data..
    cuda_check(cuModuleGetFunction(&solve_lower_with_shuffle_float, cu_module, (char *)"solve_lower_with_shuffle_float"));
    cuda_check(cuModuleGetFunction(&solve_lower_with_shuffle_double, cu_module, (char *)"solve_lower_with_shuffle_double"));
    cuda_check(cuModuleGetFunction(&solve_upper_with_shuffle_float, cu_module, (char *)"solve_upper_with_shuffle_float"));
    cuda_check(cuModuleGetFunction(&solve_upper_with_shuffle_double, cu_module, (char *)"solve_upper_with_shuffle_double"));
