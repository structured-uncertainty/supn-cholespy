...
extern CUfunction solve_upper_with_shuffle_float;
extern CUfunction solve_upper_with_shuffle_double;
extern CUfunction solve_lower_with_shuffle_float;
extern CUfunction solve_lower_with_shuffle_double;
